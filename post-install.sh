...
sudo apt-get -qq -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confnew" install -qq git build-essential python toilet apt-cacher-ng ansible python-pip
